  ...
  try {
    ...
    const prompt = `
      ...
      จงดึงข้อมูลออกมาให้อยู่ในรูปแบบ JSON เท่านั้น โดยมีโครงสร้างดังนี้:
      {
        ...
        "date": "วันที่บนบิล (แปลงให้อยู่ในรูปแบบ YYYY-MM-DD เช่น 2026-03-04) กฎการแปลง: 1. ตัวเลขชุดแรกคือวัน ชุดที่สองคือเดือน 2. หากปีเป็นเลข 2 หลัก เช่น '69' หรือ '67' ให้ถือว่าเป็น พ.ศ. ย่อ (เช่น 69 คือ 2569 = 2026 ค.ศ.) 3. หากปีเป็นเลข 2 หลักน้อยๆ เช่น '24' ให้ถือว่าเป็น ค.ศ. (2024) 4. หากปีเป็น พ.ศ. เต็ม (เช่น 2569) ให้ลบ 543 เพื่อเป็น ค.ศ. ถ้าหาไม่เจอให้ใส่ค่าว่าง",
        "items": [
          {
