    ...
    <main className="min-h-screen p-4 md:p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8 flex justify-between items-start">
          <div>
            <Link href="/income/branch-transfer" className="text-sm text-slate-500 hover:text-indigo-600 mb-2 inline-block">
              ← กลับ
            </Link>
            <h1 className="text-2xl font-bold text-slate-800">รายละเอียตรายรับ</h1>
            <p className="text-slate-500 mt-1">
              {transaction.description || "โอนเข้าจากสาขา"} | {transaction.currency} {transaction.amount.toLocaleString()}
            </p>
          </div>
