...
```
[2026-09-03] feat(employee-labor): split employee receipt address into house no, street, subdistrict, district, province and align with voucher template slots
