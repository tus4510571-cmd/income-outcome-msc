        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="card shadow-sm border border-slate-100">
             ...
             <div className="border border-slate-300 rounded-lg overflow-x-auto bg-slate-200 p-4">
                <div id="receipt-capture" className="p-10 font-sans border shadow-sm mx-auto my-0 flex flex-col" style={{ width: "794px", height: "1040px", minHeight: "1040px", backgroundColor: "#ffffff", color: "#000000", borderColor: "#e5e7eb", boxSizing: "border-box" }}>
